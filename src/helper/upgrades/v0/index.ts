...
// v1 imports
import { MidiArray } from '../v1/midi-array';
import { Project as v1Project } from '../v1/project';
import { stringify } from '../v1/util';
import { Color } from '../v1/driver-types';
import {

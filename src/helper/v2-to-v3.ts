...
import { Project } from './legacy/v3/project';
import {
  DeviceConfig,
  AdapterDeviceConfig,
...
import { stringify, parse } from './legacy/v3/util';
import { InputResponse } from './legacy/v3/driver-types';
import {
  OverrideablePropagator,
  ColorConfigPropagator,
} from './legacy/v3/propagators';
...
import { parse as v2Parse, stringify as v2Stringify } from './legacy/v2/util';
...
function upgradeToV3(projectString: string) {
...
export class V2ToV3 extends BaseUpgrade {
  applyUpgrade(v2ProjectString: string) {
    return upgradeToV3(v2ProjectString);
  }
